...
with sqlite3.connect("../db/school.db") as conn:
    ...
    conn.commit() # more writes, so we have to commit to make them final!Try this out, and then view the database in VSCode to see if the entries are created.  You may have to close your view of school.db and open it again to see your changes.
